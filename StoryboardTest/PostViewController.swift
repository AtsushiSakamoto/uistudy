...
//    @IBOutlet weak var postCell: UITableViewCell!
    ...
    func tableView(_ table: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case 0 :
            ...
            roomidTextField = UITextField(frame: CGRect(x: 200,y: 6,width: 200,height: 30))
            
//            roomidTextField.trailingAnchor.constraint(equalTo: postTable.trailingAnchor, constant: 30.0).isActive = true
        ...
        case 1 :
            ...
            readerTextField = UITextField(frame: CGRect(x: 200,y: 6,width: 200,height: 30))
        ...
        case 2 :
            ...
            commentTextField = UITextField(frame: CGRect(x: 200,y: 6,width: 200,height: 30))
        ...
        case 3 :
            ...
            continyuityTextField = UITextField(frame: CGRect(x: 200,y: 6,width: 200,height: 30))
        ...
        default :
            ...
            dungeonidTextField = UITextField(frame: CGRect(x: 200,y: 6,width: 200,height: 30))
